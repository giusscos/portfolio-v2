...
<template>
  <section class="py-40" id="about">
    ...
    <div class="grid justify-items-center">
      <p class="paragraph-medium w-full lg:w-1/2">
        I'm Giuseppe, a web and mobile freelance developer with over 2 years of professional experience. I'm specialized
        in
        front-end development using <b>Vue</b>, <b>Nuxt</b>, <b>React</b>, <b>Next</b> and <b>React Native</b>. On the back end, I primarily
